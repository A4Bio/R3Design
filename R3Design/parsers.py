...
def create_parser():
    ...
    parser.add_argument('--ex_name', default='training', type=str)
    parser.add_argument('--use_gpu', default=True, type=bool)
    parser.add_argument('--gpu', default=0, type=int)
    parser.add_argument('--seed', default=4111, type=int)
    ...
    # method parameters
    parser.add_argument('--method', default='R3Design')
    ...
    parser.add_argument('--aug_log_case', default=1, type=int)
    parser.add_argument('--ss_case', default=1, type=int)
